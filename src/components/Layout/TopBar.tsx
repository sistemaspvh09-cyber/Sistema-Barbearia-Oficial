...
import { Search, Bell, Settings, Plus, ShoppingCart } from 'lucide-react';
...
const TopBar = () => {
  ...
  return (
    <header className="fixed top-0 right-0 w-full lg:w-[calc(100%-16rem)] xl:w-[calc(100%-18rem)] h-16 lg:h-20 z-40 bg-[#0D0D0D]/80 backdrop-blur-xl border-b border-white/10 flex justify-between items-center px-4 lg:px-8">
      {/* Mobile Title (hidden on large screens to give space for search) */}
      ...
      <div className="flex items-center gap-3 lg:gap-4">
        ...
        <div className="flex items-center gap-3 lg:gap-4 border-l border-white/10 pl-3 lg:pl-4">
          <button className="relative text-[#A0A0A0] hover:text-[#C8FF00] transition-colors">
            <Bell size={20} />
        ...
        <div className="flex items-center gap-3 group cursor-pointer">
          <div className="hidden md:block text-right">
            <p className="text-sm font-bold text-white group-hover:text-[#C8FF00] transition-colors">Admin BarberPro</p>
            <p className="text-[10px] text-on-surface-variant uppercase tracking-wider">Unidade Matriz</p>
          </div>
          <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full border-2 border-[#C8FF00]/30 p-0.5 overflow-hidden group-hover:border-[#C8FF00] transition-all">
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuCdqYzj7PHfFO16nom8scALEScmuHrKs9oCPfefNPchitcuXXO7aKrmLtkbXG--b-H8u0-xVyJT78jZ4DeJnVFmopUWmc7S_GU4Ow8Rs5PueNGkrJgbGk18QK_8-nWjyB0sBab_2wGg_54b-_2n5DELrIgZGv05H2kQm4RF-_rT-JWRJWS_Lt6AJBRe9ZntWhnxTJ6KLg_FAem86SasjdBIVszzyMq20RYg9dYQ1h-jBAyLBYGWSqR6xZlbAUEEpFrZIokmdzyMAQrl" 
              alt="Admin Profile" 
